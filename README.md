...
After installation, you will be able to see metrics of the NodeJS app in provisioning Grafana dashboard, see logs of it in ArgoCD, see what Prometheus is collecting and so on.
